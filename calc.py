...
btn_prc = tk.Button(win, text='to BIN', command=convert_to_binary)
btn_prc.grid(row=2, column=0, sticky='wens')
btn_CE = tk.Button(win, text='CE')
btn_CE.grid(row=2, column=1, sticky='wens')
